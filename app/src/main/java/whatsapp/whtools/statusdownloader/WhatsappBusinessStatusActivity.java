...
import whatsapp.whtools.statusdownloader.Adapters.ViewPagerAdapter;
import whatsapp.whtools.statusdownloader.Fragment.WhatsappBusinessFragmentImages;
import whatsapp.whtools.statusdownloader.Fragment.WhatsappBusinessFragmentVideos;
...
public class WhatsappBusinessStatusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagesFrafments = new WhatsappBusinessFragmentImages();
        videosFragments = new WhatsappBusinessFragmentVideos();
    ...
    private void addTabs(ViewPager viewPager) {
        ...
        adapter.addFrag(new WhatsappBusinessFragmentVideos(), "Videos");
        adapter.addFrag(new WhatsappBusinessFragmentImages(), "Images");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_whatsapp_refresh:
                try {
                    startActivity(new Intent(this, WhatsappBusinessStatusActivity.class));
                    finish();
//                    loadStatusVideoAndImages();
