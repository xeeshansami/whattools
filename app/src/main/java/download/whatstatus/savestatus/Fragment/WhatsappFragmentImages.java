...
import download.whatstatus.savestatus.Adapters.AllImagesAdapter;
 ...
 * Use the {@link WhatsappFragmentImages#newInstance} factory method to
 * create an instance of this fragment.
 */
public class WhatsappFragmentImages extends Fragment {
    ...
    private static WhatsappFragmentImages inst;
    RecyclerView missedcalled_recyler;

    public WhatsappFragmentImages() {
    ...
    public static WhatsappFragmentImages newInstance(String param1, String param2) {
        WhatsappFragmentImages fragment = new WhatsappFragmentImages();
    ...
    public static WhatsappFragmentImages instance() {
        return inst;
    }
